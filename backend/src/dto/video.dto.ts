...
export interface VideoDto {
  ...
  /**
   * Absolute path of the cover image, or null when none could be made.
   *
   * Never fatal: a video without a chosen cover still publishes, and the
   * platform falls back to its own first-frame grab.
   */
